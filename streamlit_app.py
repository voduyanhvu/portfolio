...
st.set_page_config(page_title='Andrew Vo - Portfolio',page_icon="☀", layout="wide")
...
image = Image.open('./image/GPU.png')
...
## Contact Infomation
''')
txt2('Phone', '0123456789')
txt2('Zalo', '0123456789')
txt2('Address', 'Thu Duc City, Ho Chi Minh City, Vietnam')
txt2('Email', '[abc@gmail.com](mailto:pvhealthcare@gmail.com)')
